...
def minibatch_parse(sentences, model, batch_size):
    ...
    while unfinished_parses: # When the list is not empty
        minibatch_parses = unfinished_parses[:batch_size]
        minibatch_transtions = model.predict(minibatch_parses)
        for parse, trainstion in zip(minibatch_parses, minibatch_transtions):
            parse.parse_step(trainstion)
